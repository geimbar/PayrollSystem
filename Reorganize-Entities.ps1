...
if (Test-Path "$entitiesPath\Employees\Department.cs") {
    ...
    Write-Host "  ✓ Moved: Department.cs → Employment/" -ForegroundColor Green
}

# TaxBracket: Audit → Tax
if (Test-Path "$entitiesPath\Audit\TaxBracket.cs") {
    ...
    Write-Host "  ✓ Moved: TaxBracket.cs → Tax/" -ForegroundColor Green
}
...
if (Test-Path "$entitiesPath\Payroll\PayrollTax.cs") {
    ...
    Write-Host "  ✓ Moved: PayrollTax.cs → Tax/" -ForegroundColor Green
}
...
if (Test-Path "$entitiesPath\Audit\AuditLog.cs") {
    ...
    Write-Host "  ✓ Moved: AuditLog.cs → System/" -ForegroundColor Green
}
Write-Host ""
